...
def edit_arabic_report():
    ...
    استخرج موضوع المقال في جملة واحدة بناءً على النص، وحدد من اثنان لثلاث نظر للتقرير كحد اقصى من الخيارات التالية: [سياسي, إقتصادي, إجتماعي, تكنولوجي, بيئي, ثقافي, علمي, قانوني]. قدم الإجابة كالتالي:
...
يجب ان كل  content يحتوي على سبع فقرات كبار و طوال مليئين بالتفاصيل الغنية 
...
يجب ان تكون الاجابة في شكل JSON فقط يتكون من :    
    **تفاصيل المحتوى المطلوب:**
    - يجب أن يحتوي كل "content" على 6-8 فقرات مفصلة وغنية بالتفاصيل.
